...
#########################################################################################finish aspp implementation and understanding
        ...
        # This is explained in the deeplabv3 paper section 3.3
        self.global_pooling = nn.AdaptiveAvgPooling2d(1) # Global pooling, output size 1
        self.relu = nn.ReLU(inplace=True)
        # Defining convolutions with atrous rates [1, 6, 12, 18]
        ...
        self.conv2 = conv(depth*5, depth, kernel_size=1, stirde=1, bias=False)
